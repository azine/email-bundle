    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode
            ->children()
                ...
                ->scalarNode	(AzineEmailExtension::TRACKING_PARAM_CAMPAIGN_NAME)		->defaultValue('utm_campaign')	->info("See https://support.google.com/analytics/answer/1033867 for more infos")->end()
                ->scalarNode	(AzineEmailExtension::TRACKING_PARAM_CAMPAIGN_TERM)		->defaultValue('utm_term')		->info("See https://support.google.com/analytics/answer/1033867 for more infos")->end()
